...
import { log as globalLog, error as globalError, EComponent2Status, getComponent2Status, updateComponent2Status, getIdFromAppxInstance, instanceKeyPropNames, } from './utils.js';
...
export function functionalMiniElement(element, displayName /* 用于问题排查，和小程序 axml 无关 */, elementType, defaultProps, _targetPlatform) {
    var _a;
    ...
    var finalOptions = buildOptions(elementType, defaultProps, initData, lifeCycleHandlers, userEventHandlers, null, observers);
