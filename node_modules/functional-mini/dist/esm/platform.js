...
// 保留字，不允许开发者注册使用
export var blockedProperty = ['mixins', 'methods', 'observers'];
export var platformConfig = (_a = {},
    _a[ETargetPlatform.alipay] = {
        ...
        buildOptions: function (elementType, props, data, lifeCycleHandlers, userEventHandlers, options) {
    ...
    _a[ETargetPlatform.wechat] = {
        ...
        buildOptions: function (elementType, props, data, lifeCycleHandlers, userEventHandlers, options, observers) {
            if (options === void 0) { options = null; }
            if (elementType === EElementType.page) {
                return Object.assign({
                    data: data,
